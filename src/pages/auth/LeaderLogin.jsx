      ...
      >
        <div className="text-center mb-16">
          <div className={`w-24 h-24 rounded-[3rem] ${theme.bg} grid place-items-center mx-auto mb-8 shadow-xl ${theme.shadow}`}>
            <theme.icon size={48} className="text-on-tertiary-fixed" />
          </div>

          <h1 className="display-sm text-primary mb-4">
            Leader<span className="text-tertiary-fixed-dim italic"> Portal</span>
          </h1>
        ...
        <Card className="p-12 md:p-16 shadow-whisper border-none bg-surface-container">
          <form onSubmit={handleSubmit} className="flex flex-col gap-8">
            ...
            <Input 
              ...
              required 
              icon={Mail} 
              placeholder="leader@gmkc-church.org"
            />
            ...
            <Button type="submit" loading={loading} className={`h-16 ${theme.bg} hover:opacity-90 text-on-tertiary-fixed border-none shadow-xl ${theme.shadow}`}>
              Sign In as Leader <ArrowRight size={20} className="ml-3" />
            </Button>
          </form>
        </Card>
        ...
        <div className="mt-12 text-center">
          <p className="text-primary/40 text-xs font-medium">
            Not a Leader? <Link to="/login/admin" className="text-primary font-black uppercase tracking-widest hover:underline ml-2">Admin Login</Link> or <Link to="/login/finance" className="text-primary font-black uppercase tracking-widest hover:underline ml-2">Finance Login</Link>
          </p>
        </div>
      </motion.div>
    </div>
