      ...
      >
        <div className="text-center mb-16">
          <div className="w-24 h-24 rounded-[3rem] bg-primary grid place-items-center mx-auto mb-8 shadow-xl shadow-primary/10">
            <Zap size={48} className="text-on-primary" />
          </div>
          <h1 className="display-sm text-primary mb-4">
            Youth<span className="text-tertiary-fixed-dim italic"> Ministry</span>
          </h1>
          <p className="label-sm opacity-60 uppercase tracking-widest">
            Youth Engagement & Programs Portal
          </p>
        </div>
        ...
        <Card className="p-12 md:p-16 shadow-whisper border-none bg-surface-container">
          <form onSubmit={handleSubmit} className="flex flex-col gap-8">
            <Input
              label="Youth Ministry Email"
              type="email"
              value={email}
              onChange={(e) => setEmail(e.target.value)}
              required
              icon={Mail}
              placeholder="youth@gmkc-church.org"
            />
            <Input
              label="Password"
              type="password"
            ...
            <Button type="submit" loading={loading} className="h-16 bg-primary hover:opacity-90 text-on-primary border-none shadow-xl shadow-primary/10">
              Sign In to Youth Ministry <ArrowRight size={20} className="ml-3" />
            </Button>
          </form>
        </Card>
        ...
        <div className="mt-12 text-center">
          <p className="text-primary/40 text-xs font-medium">
            ...
            <Link to="/login/shepherd" className="text-primary font-black uppercase tracking-widest hover:underline ml-1">Shepherd</Link>
          </p>
        </div>
      </motion.div>
    </div>
